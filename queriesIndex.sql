...
-- add new meeting
insert into myEventsClient values("A21a0f5x5m", '2021-05-01 02:00:00',"Settlement Meeting");

-- reschedule meeting
update myEventsClient 
set 
myEventsClient.when = '2021-05-01 04:30:00'
where userID = "A21a0f5x5m" and myEventsClient.when = '2021-05-01 02:00:00';

-- delete details of cancelled meting
delete from myEventsClient 
where userID = "A21a0f5x5m" and myEventsCLient.when = '2021-05-01 04:30:00';
